...
class CCA(G_CCA):
    ...
    def __init__(self, n_components=2, reg_param=0.1):
        G_CCA.__init__(self, n_components, reg_param)
    ...
    def save_params(self, filepath):
        ...
        G_CCA.save_params(self, filepath)
        if len(self.z_p) != 0:
    ...
    def load_params(self, filepath):
        ...
        G_CCA.load_params(self, filepath)
