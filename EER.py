...
cca_match_result = cosine_similarity(merge_gallery,test_merge)
lda_match_result = cosine_similarity(weights,query)
code_match_result = cosine_similarity(code_gallery,test_code_feature)
...
test_score = np.sum(our_score > 0.635545550667493)
...
our_auc =auc(our_fpr,our_tpr)
res_auc =auc(res_fpr,res_tpr)
pca_auc =auc(pca_fpr,pca_tpr)
lda_auc =auc(lda_fpr,lda_tpr)
code_auc =auc(code_fpr,code_tpr)
cca_auc =auc(cca_fpr,cca_tpr)

print("OUR_auc:", our_auc)
print("Res_auc:", res_auc)
print("Code_auc:", code_auc)
print("LDA_auc:", lda_auc)
print("PCA_auc:", pca_auc)
print("CCA_auc:", cca_auc)
