...
with torch.no_grad():
    ...
    code_cca,pca_cca = classic_cca.transform(code_gallery, weights)
    merge_gallery = np.append(code_cca,pca_cca,axis=1)

    dl_cca.fit(feature_gallery,merge_gallery)
    dl_feature_cca,classic_feature_cca = dl_cca.transform(feature_gallery,merge_gallery)
    ...
    test_code_cca,test_pca_cca = classic_cca.transform(test_code_feature, query)
    ...
    test_dl_cca, test_classic2_cca = dl_cca.transform(test_dl_feature, test_merge)
